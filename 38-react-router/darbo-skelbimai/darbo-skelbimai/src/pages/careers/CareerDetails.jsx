    ...
    <div className="career-details">
      ...
      <div className="details">
        <p>
          ...
          nostrum optio sequi, repellat nobis voluptatum necessitatibus illum
          nesciunt aut dolorem delectus facere molestiae quos asperiores quam
          modi exercitationem aliquam rerum.
        </p>
      </div>
    </div>
  );
